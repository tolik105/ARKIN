...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="text-balance relative z-20 mx-auto mb-4 mt-4 max-w-4xl text-center text-3xl font-semibold tracking-tight text-gray-700 dark:text-neutral-300 md:text-7xl">
        <Balancer>
          <motion.h2>
            ...
            <Cover>Instant Automation.</Cover>
          </motion.h2>
        </Balancer>
      </div>
      <motion.p
      ...
      >
        Coming 2025: Prebuilt AI Agents for IT & HR—zero code, zero setup. Join our waitlist to be first in line.
      </motion.p>
      ...
      >
        <Button
          ...
          href="#waitlist"
          variant="dark"
          className="w-40 text-center bg-blue-600 hover:bg-blue-700 text-white py-2 px-6 rounded-lg"
        >
          Join Waitlist
        </Button>
        ...
        <Button
          ...
          href="/#features"
          variant="primary"
          className="w-40 border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-200 hover:bg-gray-50 dark:hover:bg-neutral-800/80 dark:bg-transparent"
        >
          Learn More
        </Button>
      </motion.div>
